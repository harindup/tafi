...
static inline void tafi_frame_begin(void);

static inline void tafi_frame_end(void);
...
static int tafi_spi_exit(void);

static int tafi_data_write(const void *buf, size_t len);
